...
@Entity
@Table(name = "tiktok_account_connections")
public class TikTokAccountConnection {
    ...
    private TikTokConnectionStatus status = TikTokConnectionStatus.PENDING;
    ...
    public void onCreate() {
        ...
        if (status == null) {
            status = TikTokConnectionStatus.PENDING;
        }
        if (createdAt == null) {
            createdAt = now;
        }
